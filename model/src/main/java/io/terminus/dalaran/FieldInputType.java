...
public class FieldInputType {
    ...
    public static final String ConnectorSelector = "ConnectorSelector";
    public static final String ModelSelector = "ModelSelector";
    public static final String ServiceSelector = "ServiceSelector";
