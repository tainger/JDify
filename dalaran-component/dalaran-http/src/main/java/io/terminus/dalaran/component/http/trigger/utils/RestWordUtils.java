package io.terminus.dalaran.component.http.trigger.utils;

import io.terminus.dalaran.component.http.trigger.model.ApiInfo;
import io.terminus.dalaran.component.http.trigger.model.ApiParameter;
import lombok.val;
...
public class RestWordUtils {
    ...
    public static File buildWordFile(List<ApiInfo> apiInfoList) {
    ...
    private static void addParams(XWPFTable table, Map<String, ApiParameter> params, int currentLevel, int maxLevel) {
        for (Map.Entry<String, ApiParameter> param : params.entrySet()) {
