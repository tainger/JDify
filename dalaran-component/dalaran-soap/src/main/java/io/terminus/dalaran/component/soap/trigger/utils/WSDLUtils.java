...
import io.terminus.dalaran.component.soap.trigger.model.SoapConstants;
...
public class WSDLUtils {
    ...
    public static Definitions getOperationDefinitions(SoapApiInfo apiInfo, String runtimeLocation) {
        ...
        models.forEach((name, model) -> {
            ...
            ModelField modelField = modelSchema.getFields().get(MODEL_FIELD_ROOT);
...
//        sequence.setMaxOccurs(parent.getMaxOccurs());
        sequence.setMinOccurs("0");
