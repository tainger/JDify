...
public interface FlowRestAPI {
    ...
    Long create(@RequestBody TriggerFlowDTO model);

    @ApiOperation(value = "更新集成流")
    @PostMapping(value = "/update")
    TriggerFlowDTO update(@RequestBody TriggerFlowDTO model);
    ...
    @PostMapping("/test")
    MainLogDTO doTest(@RequestBody TestRequestDTO request);
}
