...
public class MarketManagementServiceImpl implements MarketManagementService {
    ...
    public void upload(String url) {
        File localFile = new File("/Users/jingdi/work/terminus-work/Trantor/dice/current/dalaran-starter/custom-components/target/custom-components-2.4.8.5-SNAPSHOT.jar");
