...
@Slf4j
public class ArchiveLogRetentionPolicy implements LogRetentionPolicy {
    ...
    public ArchiveLogRetentionPolicy() {
    }
    ...
    public void processing() {
        ...
        String create = "CREATE TABLE `dalaran_tracing_log` (\n" +
                ...
                "  `record_id` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',\n" +
                "  `successful` bit(1) NOT NULL,\n" +
                "  `timestamp` bigint(20) NOT NULL,\n" +
                "  `tracing_type` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,\n" +
