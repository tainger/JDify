...
public class JobAPIServiceImpl implements JobAPIService {
    ...
    @Override
    public JobConfigurationAPI getJobConfigurationAPI(ElasticJobInfo elasticJobInfo) {
        return JobAPIFactory.createJobConfigurationAPI(elasticJobInfo.getServerLists(), elasticJobInfo.getNamespace(), null);
