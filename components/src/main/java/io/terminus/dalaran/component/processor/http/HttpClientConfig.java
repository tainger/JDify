...
public class HttpClientConfig {
    ...
    @ConfigFieldInfo(label = "端口", inputType = FieldInputType.Auto, defaultValue = "80")
    private Integer port = 80;

    @ConfigFieldInfo(label = "路径", inputType = FieldInputType.String)
    private String path;

    @ConfigFieldInfo(label = "类型", inputType = FieldInputType.Radio)
    private HttpMethod method;

    @ConfigFieldInfo(label = "超时时间", inputType = FieldInputType.Auto, defaultValue = "3000L")
